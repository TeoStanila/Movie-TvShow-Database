...
public final class YoungAdult extends ResultChild {
    @Override
    public Double accept(final ChildVisitor v) {
        return v.visit(this);
    }

    public YoungAdult(final InputChild inputChild, final ChildVisitor v) {
    ...
    public YoungAdult(final ResultChild resultChild, final ChildVisitor v) {
