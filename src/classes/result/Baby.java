...
public final class Baby extends ResultChild {
    @Override
    public Double accept(final ChildVisitor v) {
        return v.visit(this);
    }

    public Baby(final InputChild inputChild, final ChildVisitor v) {
    ...
    public Baby(final ResultChild resultChild, final ChildVisitor v) {
