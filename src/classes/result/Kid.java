...
public final class Kid extends ResultChild {
    @Override
    public Double accept(final ChildVisitor v) {
        return v.visit(this);
    }

    public Kid(final InputChild inputChild, final ChildVisitor v) {
    ...
    public Kid(final ResultChild resultChild, final ChildVisitor v) {
